...
{
  ECE4750_CHECK( L"test_case_1_numcores_coreid" );

  int ncores = ece4750_bthread_get_num_cores();
  ECE4750_CHECK_TRUE( ncores == 1 || ncores == 4 );
  ECE4750_CHECK_INT_EQ( ece4750_bthread_get_core_id(), 0 );
}
...
{
  ECE4750_CHECK( L"test_case_2_spawn_core1" );

  int result = 0;

  ece4750_bthread_spawn( 1, &test_func0, &result );
  ece4750_bthread_join(1);

  ECE4750_CHECK_INT_EQ( result, 1 );
}

void test_case_3_spawn_core2()
{
  ECE4750_CHECK( L"test_case_3_spawn_core2" );

  int result = 0;

  ece4750_bthread_spawn( 2, &test_func0, &result );
...
{
  ECE4750_CHECK( L"test_case_4_spawn_core3" );

  int result = 0;

  ece4750_bthread_spawn( 3, &test_func0, &result );
...
{
  ECE4750_CHECK( L"test_case_5_spawn_all_cores" );

  int result1 = 0;
  int result2 = 0;
  int result3 = 0;

  ece4750_bthread_spawn( 1, &test_func0, &result1 );
  ece4750_bthread_spawn( 2, &test_func0, &result2 );
  ece4750_bthread_spawn( 3, &test_func0, &result3 );

  ece4750_bthread_join(1);
  ece4750_bthread_join(2);
  ece4750_bthread_join(3);

  ECE4750_CHECK_INT_EQ( result1, 1 );
  ECE4750_CHECK_INT_EQ( result2, 1 );
  ECE4750_CHECK_INT_EQ( result3, 1 );
}
...
{
  ECE4750_CHECK( L"test_case_6_multi_spawn_core1" );
  ...
  ece4750_bthread_spawn( 1, &test_func1, &result );
  ece4750_bthread_join(1);
...
{
  ECE4750_CHECK( L"test_case_7_multi_spawn_core2" );
  ...
  ece4750_bthread_spawn( 2, &test_func1, &result );
  ece4750_bthread_join(2);
...
{
  ECE4750_CHECK( L"test_case_8_multi_spawn_core3" );
  ...
  ece4750_bthread_spawn( 3, &test_func1, &result );
  ece4750_bthread_join(3);
...
{
  ECE4750_CHECK( L"test_case_9_multi_spawn_all_cores" );
  ...
  ece4750_bthread_spawn( 1, &test_func1, &result1 );
  ece4750_bthread_spawn( 2, &test_func1, &result2 );
  ece4750_bthread_spawn( 3, &test_func1, &result3 );

  ece4750_bthread_join(1);
  ece4750_bthread_join(2);
  ece4750_bthread_join(3);

  ECE4750_CHECK_INT_EQ( result1, 2 );
  ECE4750_CHECK_INT_EQ( result2, 2 );
  ECE4750_CHECK_INT_EQ( result3, 2 );
}
...
{
  ECE4750_CHECK( L"test_case_10_spawn_args" );
  ...
  ece4750_bthread_spawn( 1, &test_func2, &arg1 );
  ece4750_bthread_spawn( 2, &test_func2, &arg2 );
  ece4750_bthread_spawn( 3, &test_func2, &arg3 );
  ...
  ECE4750_CHECK_INT_EQ( result1, 1 );
  ECE4750_CHECK_INT_EQ( result2, 2 );
  ECE4750_CHECK_INT_EQ( result3, 3 );
}
...
{
  ECE4750_CHECK( L"test_case_11_spawn_accumulate" );
  ...
  ece4750_bthread_spawn( 1, &test_func3, &arg1 );
  ece4750_bthread_spawn( 2, &test_func3, &arg2 );
  ece4750_bthread_spawn( 3, &test_func3, &arg3 );
  ...
  ECE4750_CHECK_INT_EQ( sum0, 10 );
  ECE4750_CHECK_INT_EQ( sum1, 26 );
  ECE4750_CHECK_INT_EQ( sum2, 42 );
  ECE4750_CHECK_INT_EQ( sum3, 58 );
}
