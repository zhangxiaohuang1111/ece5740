...
// ece4750_bthread_init before main. Cores 1,2,3 stay in the
// ece4750_bthread_ini function, waiting in a loop we call the worker
// loop. Core 0 will return from ece4750_bthread_init and call main. In
...
// ece4750_bthread_spawn function. The master core needs the function
...
// ece4750_bthread_join function. It waits for a designated worker core
// until the worker core finishes executing its function (if any) then
// returns.

#ifndef ECE4750_BTHREAD_H
#define ECE4750_BTHREAD_H

//------------------------------------------------------------------------
// ece4750_bthread_get_num_cores
//------------------------------------------------------------------------
...
inline
int ece4750_bthread_get_num_cores()
{
  int num_cores;
...
inline
int ece4750_bthread_get_core_id()
{
  int core_id;
...
typedef void (*ece4750_bthread_spawn_func)(void*);
