...
{
  ECE4750_CHECK( L"test_case_2_basic_nomatch" );
...
{
  ECE4750_CHECK( L"test_case_3_size5" );
...
{
  ECE4750_CHECK( L"test_case_5_size17" );
...
{
  ECE4750_CHECK( L"test_case_6_eval_dataset" );
